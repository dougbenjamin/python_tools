...
def main():
   ...
   parser.add_option('-i','--pandaid',dest='pandaid',help='PanDA job ID',default=None)
   ...
   pandaid = None
   if options.pandaid is not None :
      pandaid = options.pandaid
   ...
   if options.event_service:
      if pandaid is None:
         ...
         glob_string = './' + pandaid + '/yoda_droid_*.log'
         yodalogs = sorted(glob.glob(glob_string))
